...
/***************************************
          Handcuffs::Handcuffs()
 **************************************/
Handcuffs::Handcuffs(int r, int c, int num, Space*** board) : Space(r, c, board)
{
    //empty space
    name = 'C';
...
/***************************************
  Handcuffs::addPlayer()
 **************************************/
void Handcuffs::addPlayer(Player &p1)
{
...
/***************************************
 Handcuffs::movePlayer()
 **************************************/
Player Handcuffs::movePlayer(Player &p1)
{
    if (!playerVect.empty())
    {
...
/***************************************
 Handcuffs::getSpaceNum
 **************************************/
int Handcuffs::getSpaceNum()
{
    return spaceNum;
}
